...
// func TestGameStageMessage(t *testing.T) {
// 	t.Parallel()
...
// 	g.Stage = blackjack.StageStart
// 	g.StageMessage = blackjack.StageStart.Message()
...
// 	want := blackjack.Game{
// 		Stage:        blackjack.StageStart,
// 		StageMessage: "LET'S PLAY BLACKJACK!",
// 	}

// 	got := g

// 	if !cmp.Equal(want, got, cmpopts.IgnoreUnexported(blackjack.Game{}), cmpopts.IgnoreFields(blackjack.Game{}, "Players", "CountCards", "Shoe", "Random")) {
// 		t.Error(cmp.Diff(want, got))
// 	}
